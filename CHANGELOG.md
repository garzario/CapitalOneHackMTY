...
- What a client gets when the product is wrong, on both sides of the error, and the law that decides
  ...
  `docs/12-judge-qa.md` gains "Second table of 12 September" with the thirty-second spoken answer and
  the five gaps to volunteer. Nothing here has been reviewed by counsel and the article 20 consultation
