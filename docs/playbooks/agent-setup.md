...
5. Follow the playbooks in this folder instead of improvising: `pr-flow.md` (branch, commit, PR), `nessie-seed.md` (seed and reset), `rubric-audit.md` (score the repo against the rubric), `demo-brief.md` (keep the demo script true), `release.md` (cut `dev` into `main` and tag).
