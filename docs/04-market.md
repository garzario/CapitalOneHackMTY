...
So are 26, 48 and 69. Sources 27 and 44 are not cited in this file: they carry the segmentation
...
49 to 66 sit in `docs/05-business-model.md`, which numbers into this list and is the only file that
uses them. Sources 67 to 74 arrived with "The rate on supplier transfers, and how it is derived", and
14 and 15 were read again in the same pass and say more here than they did before.
