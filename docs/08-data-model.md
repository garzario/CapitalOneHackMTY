...
| `0009_rail_events.sql` | any Postgres 16+ | `cent_sent` and `cep_awaited` as ledger event types, the two the one-cent verification appends |
...
**`0009_rail_events.sql`** widens the same check constraint again, for the two event kinds the
