...
| Tests | 2,594 tests across 138 files on 2026-09-13: 2,476 passing, 118 skipped, 0 failing | `bun test`, re-read on this branch after merging `origin/dev`. Say passing and skipped, because a judge who runs it sees both, and re-read it after every merge. **Not said in the stand pitch at all**, because at least seven pull requests land the night before it and the terminal says it better than a presenter can |
