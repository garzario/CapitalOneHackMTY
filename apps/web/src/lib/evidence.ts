...
const LABELS: Record<string, string> = {
  ...
  plazaCode: "plaza",
  plazaCity: "ciudad de la plaza",
  plazaState: "estado de la plaza",
  plazaComparison: "comparacion de plaza",
  previousPlazaCodes: "plazas previas",
  previousPlazaPlaces: "plazas previas con su nombre",
  invoicePostalCode: "lugar de expedicion de la factura",
